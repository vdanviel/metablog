...
export default function RenderFollowing({publicUser}){
    ...
    const loadMoreAccounts = async () => {
        ...
        try {
            ...
            if (newAccounts.list.following.length === 0) {
                ...
                setAccounts(prevData => stateAccounts.concat(prevData, newAccounts.list.following));
    ...
    const renderAccounts = (accounts) => {
        ...
        if(accounts.length == 0){
            ...
            return (
                <h4><b>@{publicUser.nick}</b> doesn't follow anyone.</h4>
            )
