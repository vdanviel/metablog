...
export default function Feed() {
    ...
    const [statePubliOffset, setPubliOffset] = useState(0);//"de qual começa"
    ...
    const handle = async () => {
        ...
        const response = await items(user._id, statePubliOffset, 5);
    ...
    const handleHasNew = useCallback(async () => {
